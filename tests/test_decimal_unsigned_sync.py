...
class TestUnsignedDecimalSync(BlockchainAPIsSyncTester):
    def test_decimal_then_unsigned(self):
    ...
    def test_unsigned_then_decimal(self):
    ...
    def test_decimal_then_unsigned_short(self):
    ...
    def test_unsigned_then_decimal_short(self):
    ...
    def test_decimal_then_unsigned_long(self):
    ...
    def test_unsigned_then_decimal_long(self):
    ...
    def test_decimal_then_unsigned_no_decimal(self):
